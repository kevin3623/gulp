...
function() {
    ...
    {
        funName: "getFirstEnjoyAndThenPayQRCode",
        param: !0,
        reFun: !0,
        staticType: 0
    },
    {
        funName: "getFirstEnjoyAndThenPayAuthorization",
        param: !0,
        reFun: !0,
        staticType: 0
    },
    ...
    window.yl = {
        ...
        hasReady: function() {
            ...
            for (var a in e) window.jsbridge.add(e[a]),
            delete window.yl.readyList[a]
        },
        readydo: function() {},
        ready: function(e) {
            this.readydo = e
        ...
        call: function(e, a, n) {
            ...
            if (e === "getAuthcode") { // 针对容器的getAuthcode方法，进行改造
                ...
                if(window.sessionStorage.getItem("sdk_token") || reg.test(url)) {
                    if(window.sessionStorage.getItem("sdk_token")){ // session中 获取authcode
                    ...
                    if (window.jsbridge) window.jsbridge.add(t); // 呼起对应的原生的方法
                    else {
                ...
                if (window.jsbridge) window.jsbridge.add(t); // 呼起原生的方法
                else {
                    var r = "ListItem" + (new Date()).getTime();
                    this.readyList[r] = t
                }
